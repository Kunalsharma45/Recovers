      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            >
              World-class physiotherapists dedicated to guiding you every step
              of the way.
            </motion.p>
          </div>
          <motion.div
        ...
        {isLoading ? (
          ...
          <div className="rounded-[40px] border border-dashed border-[var(--borderSoft)] bg-white/70 px-8 py-12 text-center text-[var(--textSoft)]">
            No doctors are available yet. Add doctor records to the database to
            show them here.
          </div>
        ) : (
            ...
            {displayDoctors.map((doc, idx) => (
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[var(--textDark)] line-clamp-1">
                      {doc.name}
                    </h3>
                ...
                <p className="text-[var(--textSoft)] text-sm leading-relaxed mb-8 flex-grow">
                  {doc.bio ||
                    "Dedicated healthcare professional focused on optimizing patient recovery through evidence-based treatments."}
                </p>
